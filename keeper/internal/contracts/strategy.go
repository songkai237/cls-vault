...
// Maintain is a paid mutator transaction binding the contract method 0x6469c348.
//
// Solidity: function maintain() returns()
func (_UniswapV3Strategy *UniswapV3StrategyTransactor) Maintain(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _UniswapV3Strategy.contract.Transact(opts, "maintain")
}

// Maintain is a paid mutator transaction binding the contract method 0x6469c348.
//
// Solidity: function maintain() returns()
func (_UniswapV3Strategy *UniswapV3StrategySession) Maintain() (*types.Transaction, error) {
	return _UniswapV3Strategy.Contract.Maintain(&_UniswapV3Strategy.TransactOpts)
}

// Maintain is a paid mutator transaction binding the contract method 0x6469c348.
//
// Solidity: function maintain() returns()
func (_UniswapV3Strategy *UniswapV3StrategyTransactorSession) Maintain() (*types.Transaction, error) {
	return _UniswapV3Strategy.Contract.Maintain(&_UniswapV3Strategy.TransactOpts)
}
